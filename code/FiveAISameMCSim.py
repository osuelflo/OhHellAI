...
allTimeWins = [0,0,0,0,0]
allTimeScore = [0,0,0,0,0]
scoreList = []
dealer = 3
data = {
    "winner": [],
...
for i in range(100000):
    ...
    mcIterations = [2500,2500,2500,2500,2500]
    scoreboard,scores = playFullGame(5, dealer, True, [True, True, True, True,True], [True,True,True,True,True],["normal", "normal", "normal", "normal","normal"],[False,False,False,False,False],mcIterations,[True,True,True,True,True],[False,False,False,False,False],[False,False,False,False,False])
    ...
    data["score4"].append(scoreboard[4])
    ...
    if elapsed > 1800:
        ...
        df.to_csv(f"FiveAISameMCSim{count}HrOne.csv", index=False)
        data = {
            "winner": [],
            "score1": [],
            "score2": [],

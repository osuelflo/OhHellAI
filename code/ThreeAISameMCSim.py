...
for i in range(100000):
    ...
    mcIterations = [2500,2500,2500]
    scoreboard,scores = playFullGame(3, dealer, True, [True, True, True], [True,True,True],["normal", "normal", "normal"],[False,False,False],mcIterations,[True,True,True],[False,False,False],[False,False,False])
    ...
    if elapsed > 1800:
        ...
        df.to_csv(f"ThreeAISameMCSim{count}HrOne.csv", index=False)
        data = {
            "winner": [],
            "score1": [],
            "score2": [],

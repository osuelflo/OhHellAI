...
for i in range(100000):
    ...
    scoreboard,scores = playFullGame(4, dealer, True, [True, True, True, True], [True,True,True,True],["normal", "normal", "normal", "normal"],[False,False,False,False],mcIterations,[True,True,True,True],[False,False,False,False],[True,False,True,False])
    ...
    if elapsed > 1800:
        ...
        df.to_csv(f"FourAITricksterBid{count}HrOne.csv", index=False)
        data = {
            "winner": [],
            "score1": [],
            "score2": [],

...
if __name__ == "__main__":
    ...
    for numTricks in range(10,11):
        for numPlayers in range(4,5):
            ...
            useHeuristic = [False,False,False,True]
            isAI = [True for i in range(numPlayers)]
            # print(numTricks,numPlayers)
            PlayManyRounds(data,1,numPlayers,numTricks,numParticles,lamb,isAI,useHeuristic,mcIterations,selfish)

...
def playFullGame(numPlayers,numParticles,lamb,dealer,main,isAI,useHeuristic,bidStyle,mcIterations,selfish):
    tricks = [x for x in range(10, 0, -1)] + [x for x in range(2, 11)]
    scoreboard = [0, 0, 0, 0]
    for numTricks in tricks:
        print("DEALER: " + str(dealer))
        state = OhHellState(numPlayers,numTricks,numParticles,lamb,dealer,main,isAI,useHeuristic,bidStyle)
...
if __name__ == "__main__":
    random.seed(1000)
    mcIterations = [1000, 1000, 1000, 0]
    selfish = [True,True,True,True]
    playFullGame(4,1000, 1.3, 3, True, [True, True, True, False], [True, True, True, False],["normal", "normal", "normal", "normal"],mcIterations,selfish)

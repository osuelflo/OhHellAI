...
if __name__ == "__main__":
    ...
    mcsims = [[],[],[1000,100],[1000,100,10],[1000,100,10,1]]
    ...
    for numTricks in range(10,0,-1):
        for numPlayers in range(4,1,-1):
            ...
            for heur in heuristic:
                for heur2 in heuristic:
                    useHeuristic[0] = heur
                    useHeuristic[1] = heur2
                    # aggs[0] = agg
                    PlayManyRounds(data,40,numPlayers,numTricks,numParticles,lamb,isAI,useHeuristic,mcsims[numPlayers],selfish,aggs)
